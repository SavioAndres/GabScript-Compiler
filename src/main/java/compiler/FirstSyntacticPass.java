...
public class FirstSyntacticPass implements Constants {

    private Stack stack = new Stack();
    private Token currentToken;
    private Token previousToken;
    private Lexico scanner;
    private FirstSemanticPass semanticAnalyser;

    public void parse(Lexico scanner, FirstSemanticPass semanticAnalyser) throws LexicalError, SyntaticError, SemanticError, IOException {
